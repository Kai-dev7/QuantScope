# 🎉 QuantScope v0.1.6 正式版发布

## 📋 版本概述

QuantScope v0.1.6 是一个重大更新版本，主要解决了阿里百炼工具调用问题，完成了数据源升级，并实现了统一的LLM架构。本版本标志着项目在稳定性和功能完整性方面的重要里程碑。
...
**QuantScope v0.1.6** - 让AI金融分析更简单、更可靠、更高效！
