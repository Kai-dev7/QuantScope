...
本指南提供QuantScope各版本之间的升级方法，确保用户能够安全、顺利地升级到最新版本。
...
```bash
# 创建新目录
mkdir QuantScope-v0.1.7
cd QuantScope-v0.1.7
...
- 💬 [GitHub Discussions](https://github.com/hsliuping/QuantScope/discussions)
- 📚 [完整文档](https://github.com/hsliuping/QuantScope/tree/main/docs)
