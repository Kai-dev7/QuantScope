...
- [关于QuantScope](#关于tradingagents-cn)
- [功能相关](#功能相关)
- [模型选择](#模型选择)
- [使用技巧](#使用技巧)
- [问题排查](#问题排查)
...
**A**: QuantScope是一个基于大语言模型的AI股票分析学习平台，采用多智能体协作机制，帮助用户学习和理解股票分析方法。
...
QuantScope是**学习工具**，提供的分析仅供参考，不构成投资建议。
