...
class DataSourceManager:
    ...
    def get_stock_data(self, symbol: str, start_date: str = None, end_date: str = None, period: str = "daily") -> str:
        ...
        try:
            ...
            if is_success:
                ...
                # 数据质量异常时也尝试降级到其他数据源
                fallback_result, _fallback_source = self._try_fallback_sources(symbol, start_date, end_date)
    ...
    def _get_tushare_data(self, symbol: str, start_date: str, end_date: str, period: str = "daily") -> str:
        ...
        try:
            ...
            if cached_data is not None and not cached_data.empty:
                ...
                if provider:
                    stock_info = _run_async_sync(provider.get_stock_basic_info(symbol))
            ...
            # 使用异步方法获取历史数据
            data = _run_async_sync(provider.get_historical_data(symbol, start_date, end_date))
    ...
    def _get_akshare_data(self, symbol: str, start_date: str, end_date: str, period: str = "daily") -> str:
        ...
        try:
            ...
            data = _run_async_sync(provider.get_historical_data(symbol, start_date, end_date, period))
