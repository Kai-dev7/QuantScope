"""
QuantScope v1.0.0-preview FastAPI Backend
主应用程序入口
...
async def _print_config_summary(logger):
    ...
    try:
        logger.info("=" * 70)
        logger.info("📋 QuantScope Configuration Summary")
        logger.info("=" * 70)
...
app.include_router(scheduled_analysis.router, tags=["scheduled-analysis"])
...
app.include_router(kline.router, tags=["K线图"])
