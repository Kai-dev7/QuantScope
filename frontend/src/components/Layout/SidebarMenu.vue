<template>
  ...
  >
    <el-menu-item index="/dashboard">
      ...
      <template #title>指挥中枢</template>
    </el-menu-item>

    <el-menu-item index="/learning">
      <el-icon><Reading /></el-icon>
      <template #title>研究学院</template>
    </el-menu-item>
    ...
    <el-sub-menu index="/analysis">
      ...
      <el-menu-item index="/analysis/single">单标的研判</el-menu-item>
      <el-menu-item index="/analysis/batch">批量任务</el-menu-item>
      <!-- 新增：将分析报告作为股票分析的子菜单 -->
      <el-menu-item index="/reports">结论报告</el-menu-item>
    </el-sub-menu>
    ...
    <el-menu-item index="/screening">
      ...
      <template #title>候选筛选</template>
    </el-menu-item>

    <el-menu-item index="/favorites">
      <el-icon><Star /></el-icon>
      <template #title>观察池</template>
    </el-menu-item>

    <el-menu-item index="/paper">
      <el-icon><CreditCard /></el-icon>
      <template #title>模拟账户</template>
    </el-menu-item>
