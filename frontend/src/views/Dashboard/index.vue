  ...
  <div class="dashboard">
    ...
    <div class="welcome-section">
      <div class="welcome-content">
        ...
        <p class="welcome-subtitle">
          你的个人投研指挥台：从线索发现、交叉验证到结论输出，一屏完成。
        </p>
      </div>
    ...
    <div class="metrics-strip">
      <div class="metric-item">
        ...
        <span class="value">{{ userStats.totalAnalyses }}</span>
      </div>
      <div class="metric-item">
        <span class="label">成功任务</span>
        <span class="value">{{ userStats.successfulAnalyses }}</span>
      </div>
      <div class="metric-item">
        <span class="label">排队中</span>
        <span class="value">{{ queueStats.pending + queueStats.processing }}</span>
      </div>
      <div class="metric-item">
        <span class="label">并发上限</span>
        <span class="value">{{ userStats.concurrentLimit }}</span>
      </div>
      <div class="metric-item">
        <span class="label">今日配额</span>
        <span class="value">{{ userStats.dailyUsed }} / {{ userStats.dailyQuota }}</span>
      </div>
    </div>
    ...
    <el-card class="learning-highlight-card">
      <div class="learning-highlight">
        ...
        <div class="learning-content">
          <h2>研究学院</h2>
          <p>快速理解 AI 投研方法论：从模型能力边界、提示词策略到多智能体协作流程，形成稳定可复用的研究习惯。</p>
          <div class="learning-features">
            ...
            <span class="feature-tag">🎓 实战范式</span>
          </div>
        </div>
    ...
    <el-row :gutter="24" class="main-content">
      <!-- 左侧：快速操作 -->
      <el-col :span="16">
        <el-card class="quick-actions-card" header="高频入口">
        ...
        <!-- 最近分析 -->
        <el-card class="recent-analyses-card" header="最近任务" style="margin-top: 24px;">
        ...
        <el-card class="market-news-card" style="margin-top: 24px;">
          <template #header><span>市场快讯</span></template>
        ...
        <el-card class="favorites-card">
          <template #header>
            <div class="card-header">
              <span>观察池</span>
              <el-button type="text" size="small" @click="goToFavorites">查看全部 <el-icon><ArrowRight /></el-icon></el-button>
            </div>
          </template>
...
.dashboard {
  .welcome-section {
    background:
      radial-gradient(circle at 12% 18%, rgba(100, 201, 201, 0.25), transparent 40%),
      linear-gradient(125deg, #0f2b40 0%, #0d4e63 55%, #146067 100%);
    border-radius: 20px;
    padding: 40px;
    color: #f2f8ff;
    margin-bottom: 24px;
    ...
    align-items: center;
    box-shadow: 0 20px 40px rgba(10, 39, 58, 0.24);
    ...
    .welcome-content {
      .welcome-title {
        ...
        .version-badge {
          ...
          font-size: 12px;
          font-weight: 600;
          border: 1px solid rgba(229, 244, 252, 0.24);
        }
      }
  ...
  .metrics-strip {
    ...
    background: linear-gradient(180deg, #f7fbfd 0%, #f4f9fc 100%);
    display: grid;
  ...
  .learning-highlight-card {
    ...
    box-shadow: 0 16px 30px rgba(20, 53, 72, 0.12);
    ...
    .learning-highlight {
      ...
      .learning-icon {
        ...
        height: 80px;
        border-radius: 16px;
        background: linear-gradient(145deg, #0f8b94 0%, #177d95 100%);
        display: flex;
        align-items: center;
